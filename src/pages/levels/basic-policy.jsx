  ...
  const [questions] = useState([
    {
      ...
      image: "/q1pic.webp",
      situation:
        "You're about to create an account on a popular social media platform. Before you can proceed, a message pops up asking you to review and accept the privacy policy. What key information should you expect to find in this document?",
      answers: [
        { id: "a", text: "Just the company logo", isCorrect: false },
        {
          id: "b",
          text: "Details on data collection, usage, and how your privacy is protected.",
          isCorrect: true,
        },
        {
          id: "c",
          text: "Celebrity endorsements of the platform.",
          isCorrect: false,
        },
      ],
    },
    {
      ...
      image: "/q2pic.webp",
      situation:
        "You're working from a café, sending an email containing sensitive project details to a colleague. Considering the public Wi-Fi, why is it crucial to use encrypted communication?",
      answers: [
        {
          id: "a",
          text: "It speeds up your internet connection.",
          isCorrect: false,
        },
        {
          id: "b",
          text: "It secures your email from potential eavesdroppers, ensuring only the intended recipient can read it.",
          isCorrect: true,
        },
        {
          id: "c",
          text: "It compresses the email to save space.",
          isCorrect: false,
        },
      ],
    },
    {
      ...
      image: "/q3pic.webp",
      situation:
        "Your bank has recently introduced an optional security feature that requires not just your password, but also a code sent to your phone to access your account. This feature is known as:",
      answers: [
        {
          id: "a",
          text: "A method that requires two different passwords",
          isCorrect: false,
        },
        {
          id: "b",
          text: "Two-Factor Authentication, adding an extra layer of security to your account",
          isCorrect: true,
        },
    ...
    },
    {
      ...
      image: "/q4pic.webp",
      situation:
        "Your company is expanding its services to include customers in Europe. To comply with European law, you need to understand GDPR. What does GDPR primarily protect?",
      answers: [
        {
          id: "a",
          text: "Personal data and privacy of individuals in the EU",
          isCorrect: true,
        },
        {
          id: "b",
          text: "The interests of companies outside the EU",
          isCorrect: false,
        },
    ...
    },
    {
      ...
      image: "/q5pic.webp",
      situation:
        "You receive an email that looks like it's from your bank, asking you to confirm your account details via a link. This is likely a:",
      answers: [
        {
          id: "a",
          text: "Phishing attempt trying to trick you into giving away personal information",
          isCorrect: true,
        },
        {
          id: "b",
          text: "Legitimate security check by the bank",
          isCorrect: false,
        },
        {
          id: "c",
          text: "Routine bank survey for customer feedback",
          isCorrect: false,
        },
      ],
    },
    {
      ...
      image: "/q6pic.webp",
      situation:
        "While traveling, you need to access sensitive work documents over hotel Wi-Fi. To protect your data, you decide to use a:",
      answers: [
        {
          id: "a",
          text: "Virtual Public Network, to get faster internet speed",
          isCorrect: false,
        },
        {
          id: "b",
          text: "Very Private Network, to create a private network within a public one",
          isCorrect: false,
        },
        {
          id: "c",
          text: "Virtual Private Network, to securely connect to the internet",
          isCorrect: true,
        },
      ],
    },
    {
      ...
      answers: [
        ...
        {
          id: "b",
          text: "Personal information, such as your name or birthdate",
          isCorrect: false,
        },
        {
          id: "c",
          text: "A mix of uppercase and lowercase letters, numbers, and special characters",
          isCorrect: true,
        },
      ],
    },
  ...
  const policyQuestions = [
    {
      ...
      answers: [
        {
          id: "a",
          text: "By asking users to keep it secret",
          isCorrect: false,
        },
        {
          id: "b",
          text: "Through industry-standard encryption methods",
          isCorrect: true,
        },
    ...
    },
    {
      ...
      answers: [
        {
          id: "a",
          text: "Request data deletion or modification",
          isCorrect: true,
        },
        { id: "b", text: "Sell their data directly", isCorrect: false },
        {
          id: "c",
          text: "Share data with third parties without consent",
          isCorrect: false,
        },
      ],
    },
    ...
    },
    {
      ...
      answers: [
        ...
        {
          id: "b",
          text: "Privacy Officer at privacy@socialsphere.com",
          isCorrect: true,
        },
    ...
    },
    {
      ...
      answers: [
        {
          id: "a",
          text: "Improving service and personalizing user experience",
          isCorrect: true,
        },
        {
          id: "b",
          text: "Data is not shared under any circumstance",
          isCorrect: false,
        },
    ...
    },
    {
      ...
      answers: [
        ...
        {
          id: "b",
          text: "Names, email addresses, and browsing behavior",
          isCorrect: true,
        },
    ...
    },
    {
      ...
      answers: [
        {
          id: "a",
          text: "Yes, by adjusting their account settings",
          isCorrect: true,
        },
        { id: "b", text: "No, it’s mandatory for all users", isCorrect: false },
        {
          id: "c",
          text: "Users can opt-out but it requires a fee",
          isCorrect: false,
        },
      ],
    },
      ...
      <div className={styles.container}>
        {showIntro && (
          <div className={styles.introMessage}>
            ...
            />
            <p>
              Embark on a journey through the realms of cybersecurity. Ready to
              test your knowledge and secure the digital frontier?
            </p>
            <button onClick={handleStartLevel} className={styles.button}>
              Begin Adventure
            </button>
          </div>
        )}
        ...
        {showScore && (
          <div>
            <p>
              Your Score: {score} / {questions.length + policyQuestions.length}
            </p>
            <button onClick={navigateToLevelPage} className={styles.button}>
              Return to Home
            </button>
          </div>
        )}
          ...
          <>
            {showPolicyQuestions ? (
              <div className={styles.questionContainer}>
                <img
                  src="/policylast7q.webp"
                  alt="Digital Privacy and Cybersecurity Infographic"
                  className={styles.infographicImage}
                />
                <div className={styles.policyText}>
                  <pre>{policyText}</pre>
                </div>
                <div key={policyQuestions[currentQuestionIndex].id}>
                  <h2>{policyQuestions[currentQuestionIndex].text}</h2>
                  {policyQuestions[currentQuestionIndex].answers.map(
                    (answer) => (
                      <button
                        key={answer.id}
                        onClick={() =>
                          handleAnswerSelect(
                            policyQuestions[currentQuestionIndex].id,
                            answer.id,
                            answer.isCorrect
                          )
                        }
