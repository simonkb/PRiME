    ...
    const [emails, setEmails] = useState([
        {
          ...
          content: "Dear User, please click the link below for an important announcement.",
        ...
        },
        {
          ...
          content: "Hello, your recent invoice is ready for payment. Please find the attached invoice.",
        ...
        },
        {
          ...
          content: "Dear User, we noticed some unusual activity on your account. Click the link to verify your account.",
        ...
        },
        {
          ...
          content: "Your account security has been compromised. Click the link to secure your account.",
        ...
        },
        {
          ...
          content: "Your recent order has been confirmed. If you didn't place this order, click the link to report.",
        ...
        // Scam Emails
        {
          ...
          content: "Congratulations! You've won a prize. To claim, provide your personal information.",
        ...
        },
        {
          ...
          content: "You've won a lottery. To receive your winnings, send a processing fee.",
        },
        {
          id: 8,
          sender: "Tech Support",
          subject: "Virus Detected",
          content: "Your computer has a virus. Call this number to get immediate support.",
        },
        {
          id: 9,
          sender: "Pharmacy Discounts",
          subject: "Special Offer on Medications",
          content: "Get exclusive discounts on medications. Click the link to order.",
        ...
        },
        {
          ...
          content: "Your tax refund is pending. Click the link to provide bank details for processing.",
          ...
          {selectedEmail ? (
            <div className={styles.emailDetails}>
              <div className={styles.emailHeader}>
                ...
                <div className={styles.subject}>{selectedEmail.subject}</div>
              </div>
